...
public class TransactionService {
    ...
    // Stubs for controllers that expect these methods
    public java.util.List<Transaction> getFilteredTransactions(String accountIdFilter) {
        return java.util.Collections.emptyList();
    }

    public void addTransaction(Transaction t) {
        // no-op stub for compile
    }

    // Dùng cho TopCategories* (stub tối thiểu để compile)
    ...
    public java.util.List<CategoryStats> getTopCategoriesByMonth(UUID userId, LocalDateTime start, LocalDateTime end) {
        return java.util.Collections.emptyList();
    }
}
