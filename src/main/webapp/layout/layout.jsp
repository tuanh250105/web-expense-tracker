...
>>>>>>> feature/transaction
        ...
        <li><a href="${pageContext.request.contextPath}/budgets"><i class="fa-solid fa-wallet"></i> <span>Ngân sách</span></a></li>
        ...
        <li><a href="${pageContext.request.contextPath}/events"><i class="fa-solid fa-calendar-check"></i> <span>Quản lý sự kiện tài chính</span></a></li>
        <hr>
