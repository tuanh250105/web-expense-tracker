...
<body>
    ...
    <script>
        ...
        async function loadData() {
            ...
            try {
                var url = API_BASE + '/categories/stats';
        ...
        function updateSummaryCards() {
            ...
            for (var i = 0; i < categoriesData.length; i++) {
                totalAmount += parseFloat(categoriesData[i][4]) || 0;
                totalTransactions += parseInt(categoriesData[i][3]) || 0;
            }
            ...
            document.getElementById('topCategoryAmount').textContent = formatCurrency(topCategory[4]);
        ...
        function initializeChart() {
            ...
            for (var i = 0; i < chartData.length; i++) {
                ...
                amounts.push(parseFloat(chartData[i][4]));
            }
        ...
        function displayTable() {
            ...
            categoriesData.forEach(function(cat, index) {
                ...
                var type = cat[1] || 'N/A';
                var icon = cat[2] || '📊';
                var count = parseInt(cat[3]) || 0;
                var amount = parseFloat(cat[4]) || 0;
