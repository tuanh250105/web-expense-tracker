...
<head>
    ...
    <style>
        body {
            ...
            min-height: 100vh;
            background: linear-gradient(135deg, #2c3e50, #34495e, #5a7d9a, #4a6a8a, #3b5a7a);
...
<div class="login-container">
    ...
    <form method="get" action="${pageContext.request.contextPath}/auth/google/start">
        <button type="submit" class="google-btn">
      <span style="display:flex;align-items:center;gap:6px;">
  <i class="fa-brands fa-google" style="color:#ea4335;font-size:20px;"></i>
